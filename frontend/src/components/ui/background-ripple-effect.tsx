...
export const BackgroundRippleEffect = ({
  ...
  return (
    <div
      ...
      style={{
        "--cell-border-color": "rgb(38, 38, 38)",
        "--cell-fill-color": "rgba(23, 23, 23, 0.5)",
...
const DivGrid = ({
  ...
  cols = 30,
  cellSize = 56,
  borderColor = "var(--cell-border-color, #262626)",
  fillColor = "var(--cell-fill-color, rgba(23,23,23,0.5))",
  clickedCell = null,
  onCellClick = () => {},
  interactive = true,
}: DivGridProps) => {
  ...
  // Calculate grid dimensions to cover viewport
